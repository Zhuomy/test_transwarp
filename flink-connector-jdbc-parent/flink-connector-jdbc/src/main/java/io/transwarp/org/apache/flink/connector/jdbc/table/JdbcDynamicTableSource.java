...
import io.transwarp.org.apache.flink.connector.jdbc.split.CompositeJdbcParameterValuesProvider;
import io.transwarp.org.apache.flink.connector.jdbc.split.JdbcGenericParameterValuesProvider;
import io.transwarp.org.apache.flink.connector.jdbc.split.JdbcNumericBetweenParametersProvider;
import io.transwarp.org.apache.flink.connector.jdbc.split.JdbcParameterValuesProvider;
...
public class JdbcDynamicTableSource
  ...
  public ScanRuntimeProvider getScanRuntimeProvider(ScanContext runtimeProviderContext) {
    ...
    if (predicates.size() > 0) {
      ...
      LOG.info("joinedConditions: {}", joinedConditions);
    }
    ...
    LOG.info("Query generated for JDBC scan: : {}", query);
