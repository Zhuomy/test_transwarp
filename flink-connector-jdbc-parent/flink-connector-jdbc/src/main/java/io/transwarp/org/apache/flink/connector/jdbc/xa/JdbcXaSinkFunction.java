...
package io.transwarp.org.apache.flink.connector.jdbc.xa;

import io.transwarp.org.apache.flink.connector.jdbc.JdbcExactlyOnceOptions;
...
public class JdbcXaSinkFunction<T> extends AbstractRichFunction
  ...
  public void snapshotState(FunctionSnapshotContext context) throws Exception {
    ...
    stateHandler.store(JdbcXaSinkFunctionState.of(preparedXids, hangingXids));
  }
